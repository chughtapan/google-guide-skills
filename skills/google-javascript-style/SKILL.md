...
description: >-
  Use when writing or reviewing JavaScript under Google's source formatting, naming, module,
  language-feature, JSDoc, and policy conventions. Do not use for TypeScript; use
  google-typescript-style instead.
---
