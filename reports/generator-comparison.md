...
output, the exact excerpt selectors used, and the rule that keeps SWE-book files in an ignored
directory. A conversational generator does not record all of this by itself.
...
| This manifest pipeline | Pinned commits, exact excerpt selectors, path-level licenses, output rules, catalog, metrics, and evaluations | Requires human review of what each skill should retain | Used here |
...
- exact source-excerpt selectors;
- license checks;
